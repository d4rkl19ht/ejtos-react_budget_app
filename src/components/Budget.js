    ...
    return (
        <div className="col me-1 alert alert-secondary">
            <div className="row">
                ...
                <div className="col-7"><input type="number" className="form-control"  step="10" value={budget} onChange={dispatchEvent} onBlur={handleBudgetChange} name="budget" id="budget"></input></div>
            </div>
        </div>
    );
};
